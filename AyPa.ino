...
//nap();
  ...
  Pin2LOW(PORTD,7);//digitalWrite(SRCLR,HIGH); // can write to 595 (it is cleared now)
...
{
  I2C_ON(DDRC,1,2);
  if(!Check_RTC(16)){ERR=ERR_WHERE_IS_THE_CLOCK;} 
  else
  {
...
//ta(" tt1 ");tn(10000,tt1);ta(" 2 ");tn(10000,tt2);ta(" 3 ");tn(10000,tt3);
